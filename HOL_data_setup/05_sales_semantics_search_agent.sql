-- ============================================================
-- F5 HOL: Sales Semantics, Search Service, and Agent
-- (Attendee Setup - Step 4)
-- ============================================================
-- Creates:
--   1. File format for transcript processing
--   2. Cortex Search Service on Zoom transcripts
--   3. Sales Semantic View (accounts, opps, products, teams)
--   4. Cortex Agent for CoWork (Sales Intelligence)
--   5. Grants for PUBLIC role access
--
-- Prerequisites: 02_create_environment.sql and 03_load_data.sql
-- ============================================================
...
-- ============================================================
-- Step 1: File format for transcript processing
-- ============================================================
...
-- ============================================================
-- Step 2: Upload transcripts and create source table
-- ============================================================
-- Upload transcript .txt files to stage (run from SnowSQL in this directory):
-- PUT file://./transcripts/*.txt @F5_PROD.RAW.ZOOM_TRANSCRIPTS_STAGE AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
-- ALTER STAGE F5_PROD.RAW.ZOOM_TRANSCRIPTS_STAGE REFRESH;
...
-- ============================================================
-- Step 3: Cortex Search Service on Zoom transcripts
-- ============================================================
...
-- ============================================================
-- Step 4: Cortex Agent for CoWork
-- ============================================================
...
GRANT SELECT ON ALL TABLES IN SCHEMA F5_PROD.FINAL TO ROLE PUBLIC;
