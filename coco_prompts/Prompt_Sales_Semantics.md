...
4. Create a sales semantic view. The field names should match, again doesn't have to be all fields but should have a full account, opportunity, sales terrority, product sku and sales team information.  use the sample questions from step 3 to help structure the semantic view.
